...
El resultado a sido un sencillo dispositivo que he conectado a mi antena WiFi del mástil de comunicaciones. Porque la antena de 868,600 MHz por alguna razón tiene un corto con la masa.
...
![TTN Consola](https://github.com/McOrts/LoRa_gateway/blob/master/pictures/LORA_TTN_Node_MovementSensor.JPG?raw=true)
...
- Para el nodo, Jorge :P [akirasan](https://twitter.com/akirasan). Me ha guiado por el buen camino de código que el brillante programador Matthijs Kooijman ha dejado libre para todos nosotros (https://github.com/matthijskooijman/arduino-lmic).
